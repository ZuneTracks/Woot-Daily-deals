...
## v1.1.3 - New app name and artwork
...
- Renamed the app to "Daily Deals for Woot!" and updated the About page to match,
  describing it as a Universal Windows app for Windows 10 Mobile/Desktop.
